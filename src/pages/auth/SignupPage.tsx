...
export default function SignupPage() {
    ...
    const { signup, signInWithGoogle, isLoading } = useStore();
        ...
        <div>
            ...
            <div className="space-y-3 mb-6">
                ...
                >
                    ...
                    <span className="relative z-10 text-sm">Sign up with Google</span>
                </button>

                {/* Divider */}
                <div className="relative py-3 flex items-center">
                    <div className="flex-grow border-t border-white/[0.04]"></div>
                    <span className="flex-shrink mx-4 text-[10px] text-white/15 font-bold uppercase tracking-[0.15em]">or sign up with email</span>
                    <div className="flex-grow border-t border-white/[0.04]"></div>
                </div>
            </div>
